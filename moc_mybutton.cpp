...
#include <memory>
#include "../../borderCollie/mybutton.h"
...
QT_MOC_LITERAL(1, 9, 12), // "buttonChange"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "MyButton\0buttonChange\0"
};
...
void MyButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyButton::buttonChange)) {
                *result = 0;
                return;
            }
        }
